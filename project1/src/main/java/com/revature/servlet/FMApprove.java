...
/**
 * Servlet implementation class FMApprove
 */
public class FMApprove extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out = (mapper.writeValueAsString(ReimbursementDAO.Approve(a, serve.getByRole(param2))));
